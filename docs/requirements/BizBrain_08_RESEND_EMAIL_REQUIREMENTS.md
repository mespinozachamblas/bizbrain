...
- optional publishable wow-factor statistics with source links and confidence or freshness notes
- optional separate signal-evidence sections that make clear the numbers are internal validation or platform/trend proof, not the main publishable claim set
